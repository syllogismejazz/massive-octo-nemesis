D.statistic.plotting.all.gamma <- function(distribution="normal",max.sample.size=25, increments=2, nb.of.pvalues.each=100, c_N1=0.5, c_N2=0.5){
  ...
  if(distribution=="normal"){ 
    ...
    plot(m.vector, D.vector.gamma1, ylim=c(0, 0.5), xlab="m (first sample size)", ylab="D Statistic",main="D-Statistics each for 2000 pvalues (MEP; kappa=4)", sub="(c_N1=0.1 and c_N2=0.9)", lty=1, col=color.vector[1], type="l")
