D.statistic.plotting.small.gamma <- function(distribution="normal",max.sample.size=25, increments=2, nb.of.pvalues.each=100){
...
legend("topright", legend=c("= 0.1","= 0.25", "= 0.5"),lty=c(1,1,2),col=c("black","red", "blue"),bty="n")
